# -*- coding: utf-8 -*-
"""
Created on Sat Feb 27 14:46:39 2021
...
print('25th percentile is', f'{twenty_five_percentile_open}')


fifty_percentile_open= sorted_open[round(0.50 * (count + 1)) - 1]
print('50th percentile is', f'{fifty_percentile_open}')

seventy_fifth_percentile_open= sorted_open[round(0.75 * (count + 1)) - 1]
print('75th percentile is', f'{seventy_fifth_percentile_open}')
#descriptive statistics for Open 

print("Descriptive Statistics for Open: \n --------------------------------")
...
#descriptive statistics for high 

print("Descriptive Statistics for High: \n --------------------------------")
...
print('25th percentile is', f'{twenty_five_percentile_high}')


fifty_percentile_high= sorted_high[round(0.50 * (count + 1)) - 1]
print('50th percentile is', f'{fifty_percentile_high}')

seventy_fifth_percentile_high= sorted_high[round(0.75 * (count + 1)) - 1]
print('75th percentile is', f'{seventy_fifth_percentile_high}')


#descriptive statisctics for Low 

print("Descriptive Statistics for Low: \n --------------------------------")
...
print('25th percentile is', f'{twenty_five_percentile_low}')


fifty_percentile_low= sorted_low[round(0.50 * (count + 1)) - 1]
print('50th percentile is', f'{fifty_percentile_low}')

seventy_fifth_percentile_low= sorted_low[round(0.75 * (count + 1)) - 1]
print('75th percentile is', f'{seventy_fifth_percentile_low}')


# descriptive statistics for Change 

print("Descriptive Statistics for Change: \n --------------------------------")
...
print('25th percentile is', f'{twenty_five_percentile_change}')


fifty_percentile_change= sorted_change[round(0.50 * (count + 1)) - 1]
print('50th percentile is', f'{fifty_percentile_change}')

seventy_fifth_percentile_change= sorted_change[round(0.75 * (count + 1)) - 1]
print('75th percentile is', f'{seventy_fifth_percentile_change}')
